const crearProyecto = (nombre, resumen, descripcion, tecnologias, linkWeb, linkGithub, imagen) => ({
    nombre,
    resumen,
    descripcion,
    tecnologias,
  ...
  export const proyectos = [
    ...
    crearProyecto(
      "Proyecto heladería C# ASP.NET UNLZ",
    ...
    crearProyecto(
      "Proyecto Carrito de compras Java UNLZ",
